...
CREATE_SKETCH_RECTANGLE_DESCRIPTION = (
    ...
    "tool for centred, rotated, rounded, construction, or partially constrained rectangles. "
    "Translate a centred natural-language request to its lower-left coordinates only when that "
    "translation is explicit from the requested width and height; the public placement variant "
    "remains lower_left. After creation, recompute and inspect the semantic result. When a "
