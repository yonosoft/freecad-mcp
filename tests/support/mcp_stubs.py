...
def make_handlers(adapter: AdapterStub | None = None) -> tuple[HandlerGroups, AdapterStub]:
    ...
    return (
        HandlerGroups(
            ...
            sketcher=SketcherHandlers(
                ...
                create_sketch_polyline=CreateSketchPolylineHandler(actual_adapter, dispatcher),
