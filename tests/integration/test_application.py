...
def test_application_whole_sketch_handlers_are_constructed() -> None:
    application = make_application()
    assert hasattr(application.handlers.sketcher, "translate_sketch")
    assert hasattr(application.handlers.sketcher, "rotate_sketch")
    assert hasattr(application.handlers.sketcher, "scale_sketch")
    assert hasattr(application.handlers.sketcher, "mirror_sketch")
